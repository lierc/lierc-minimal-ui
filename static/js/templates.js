...
templates['nav_item'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<a class=\"fa fa-file-text-o panel-log\" title=\"View logs\" href=\""
    + container.escapeExpression(((helper = (helper = helpers.log_url || (depth0 != null ? depth0.log_url : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"log_url","hash":{},"data":data}) : helper)))
    + "\" target=\"_blank\"></a>";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;
  ...
  return "<li data-panel-id=\""
    ...
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.closable : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.log_url : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</li>\n";
},"useData":true});
